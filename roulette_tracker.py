...
class ShotTrackerApp(QMainWindow):
    def __init__(self):
        ...
        # Top row with Shot on left and Shells left on the right
        top_row = QHBoxLayout()
        
        # Left side: Shot label stacked
    ...
    def update_history(self):
        ...
        if not self.shot_history:
            ...
            for idx, (shot_type, shot_num) in enumerate(self.shot_history):
                ...
                item = QLabel(f"Shot {shot_num}  -  {shot_type}")
